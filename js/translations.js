...
var translations = {
    en: {
        ...
        factoryProdDescFull: "先进的CNC光学研磨和抛光机，用于精密元件制造。",
        factoryProdDetail: "CNC研磨与抛光",
        factoryCoatingTitle: "镀膜中心",
        factoryCoatingDescFull: "先进的真空镀膜系统，用于镀制减反射膜、高反射膜和介质膜。",
        factoryCoatingDetail: "AR、HR、介质膜",
        factoryTestDescFull: "完整的检测能力，包括干涉仪、分光光度计和表面质量验证。",
        factoryTestDetail: "100%检测率",
        factoryCleanDescFull: "千级无尘环境，用于光学装配、镀膜和最终检测流程。",
        factoryCleanDetail: "千级 ISO 7",
        ourTeam: "我们的团队",
        ourTeamDesc: "了解PhotonEdge精密光学解决方案背后的专业团队",
        teamCEO: "林伟",
        teamCEORole: "首席执行官兼创始人",
        teamCEOBio: "精密光学行业15年以上经验。2010年创立PhotonEdge，致力于从中国提供世界级光学元件。",
        teamTech: "张杨博士",
        teamTechRole: "技术总监",
        teamTechBio: "光学工程博士。领导研发和技术支持，在光学设计和镀膜技术方面有深厚专业知识。",
        teamSales: "李晨",
        teamSalesRole: "销售总监",
        teamSalesBio: "国际贸易专家，全球光学元件贸易10年以上经验。管理50多个国家的客户关系。",
        contactMe: "联系我",
        ...
        qcIncoming: "来料检验",
        qcIncomingDesc: "所有原材料和元件在进入生产前都经过规格验证",
        qcInProcess: "过程检验",
        qcInProcessDesc: "在每个生产阶段检查关键尺寸和表面质量",
        qcFinal: "最终检验",
        qcFinalDesc: "使用干涉仪、分光光度计和目视检查进行100%检测",
        qcShipping: "发货验证",
        qcShippingDesc: "发货前进行包装检验和文件审核",
        ...
        techCatalog: "产品目录",
        techCatalogDesc: "完整的产品目录，涵盖透镜、反射镜、窗口、棱镜、滤光片、分光镜和偏振片。",
        techCoC: "合格证书",
        techCoCDesc: "标准合格证书模板，记录材料、尺寸、表面质量和镀膜规格。",
        techCoating: "镀膜性能曲线",
        techCoatingDesc: "我们标准减反射膜、高反射膜和介质膜在各波长范围的透射率和反射率曲线。",
        techCAD: "CAD文件 (STEP)",
        techCADDesc: "标准光学元件的3D CAD STEP格式模型。可直接集成到您的设计中。",
        techTestReport: "测试报告样本",
        techTestReportDesc: "展示干涉仪数据、分光光度计结果和尺寸测量的检验报告样本。",
        techMSDS: "材料安全数据",
        techMSDSDesc: "光学材料的安全数据表，包括硒化锌、锗、氟化钙和其他特殊材料。",
        downloadNow: "立即下载",
        // Home Page Trust
        homeIndustryStripTitle: "满足多个行业的精密光学需求",
        homeCertTitle: "认证与合规",
        certISODescFull: "质量管理体系",
        certRoHSDescFull: "环境安全标准",
        certREACH: "REACH合规",
        certREACHDescFull: "化学品安全法规"
    },
    zh: {
        navHome: "首页",
        navProducts: "产品",
